...
function init() {
   ...
   // Add an eveent listener for the mouseup event
   ...
   document.getElementById("solve").addEventListener("click", 
      function() {
         // Remove the inline background style from each cell
...
function setupPuzzle() {
   ...
   for (var i=0; i < puzzleCells.length; i++) {
      ...
      // Use a pencil image as the cusor
   ...
   document.getElementById("peek").addEventListener("click", 
         function() {
            // Disply incorrect white cells in pink
            ...
            setTimeout(
               function(){
                  // Change the cells back to their original color, remove the hint colors
                  for (var i = 0; i < puzzleCells.length; i++) {
...
function setBackground(e) {
   ...
   // Set the background based on key press
   ...
   for (var i = 0; i < puzzleCells.length; i++) {
      puzzleCells[i].addEventListener("mouseenter", extendBackground, false);
      puzzleCells[i].style.cursor = cursorType;
   }
   //Prevent the default action of higlighting text
   e.preventDefault();
}
...
function endBackground() {
   // Remove the event listener for every puzzle cell
      ...
      for (var i = 0; i < puzzleCells.length; i++) {
      puzzleCells[i].removeEventListener("mouseenter", extendBackground, false);
